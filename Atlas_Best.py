...
xls = pd.read_excel("Result/Atlas_Site/Cross_AdaBoostClassifier.xls",sheet_name="Accuracy")
...
sheet = Sheets[0]
xlsfile = glob.glob("Result/Atlas_Site/*.xls")
...
for i,file in enumerate(xlsfile):
    ...
    xls = pd.read_excel(file,sheet_name="Specificity")
...
finaldata.to_excel("Result/Atlas_Site/total.xls")
